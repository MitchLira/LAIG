...
CircularAnimation.prototype.rotateAnimation = function(currTime) {
		...
		{
			this.position = new getXYZ(this.center.x + this.radius*Math.sin(this.rotang+this.startang),
										this.center.y,
		...
		this.position = new getXYZ(this.center.x + this.radius*Math.sin(angleRotated + this.startang),
								 this.center.y, 
